...
const AddRating: React.FC<AddRatingProps> = ({itemId, onOpen}) => {
  return (
    <div className=" w-36 absolute left-0 top-4 bg-white rounded-sm border shadow-sm">
      ...
      <p onClick={onOpen} className=" text-base text-blue-600 hover:underline cursor-pointer py-1 px-2 border-t">
        Add Reviews
      </p>
    </div>
  );

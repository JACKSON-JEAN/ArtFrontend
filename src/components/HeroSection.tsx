        ...
        <section className="bg-gradient-to-r from-red-950 to-red-900 rounded-md flex-1 flex items-center mb-4 md:mb-0 py-6">
          <div className="px-4 sm:px-10 md:px-20">
            <h1 className="text-xl md:text-2xl font-thin capitalize font-serif text-white mb-2">
              Pearl Art Galleries – Original African Art Collections
            </h1>
            <h2 className="sr-only">
              Buy Original African Art, Paintings & Sculptures Online
            </h2>
            <p className="text-lg font-light text-amber-50 mb-6">
              ...
              embodies this legacy with original Ugandan and African artworks,
              hand-selected from local artists. These unique paintings and
              contemporary art pieces bring Uganda’s vibrant soul to your home
              or office, inspiring joy.
            </p>

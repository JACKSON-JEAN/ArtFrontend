...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Us | Pearl Art Galleries</title>
        <meta
          name="description"
        ...
        <meta
          ...
          content="Discover Pearl Art Galleries, our mission, story, and team connecting African artisans to the world."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="About Us | Pearl Art Galleries" />
        <meta
          name="twitter:description"
          content="Learn about Pearl Art Galleries — connecting African artisans to the world."
        />
        <meta
          name="twitter:image"
          content="https://res.cloudinary.com/dsawd9eso/image/upload/v1760269340/jean_bhijkx.webp"
      ...
      >
        ...
        <p className=" text-lg text-red-950 font-semibold mb-2">
          Meet our team.
        </p>

    ...
    <div className=" w-full flex justify-center px-10 sm:px-20 min-h-screen py-4 bg-slate-50">
      <div className=' flex items-center flex-col'>
        ...
        >
          ...
          {error.isError &&
            <p className=' text-xs text-red-700 bg-red-100 rounded-sm mb-2 p-1'>{error.errorMessage}</p>      
          }  
          ...
          <div className=" mt-4 py-2 border-t">
            <p>
              Have no account? <Link to='/signup' className=" text-blue-600 cursor-pointer">Sign up</Link>
            </p>
          </div>
        </form>
      </div>
